...
<input type="radio" name="lan" value="A">  A<BR>
<input type="radio" name="lan" value="B">B<BR>
<input type="radio" name="lan" value="C">   C<BR>
<input type="radio" name="lan" value="D">  D<BR>
<input type="radio" name="lan" value="E">  E<BR>
</font></center><br>
